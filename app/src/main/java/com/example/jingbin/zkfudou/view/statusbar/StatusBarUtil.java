package com.example.jingbin.zkfudou.view.statusbar;
...
public class StatusBarUtil {
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTranslucentForImageViewInFragment(Activity activity, View needOffsetView, DrawerLayout drawerLayout) {
        setTranslucentForImageViewInFragment(activity, DEFAULT_STATUS_BAR_ALPHA, needOffsetView,  drawerLayout);
    }
     ...
     * @param needOffsetView 需要向下偏移的 View
     */
    public static void setTransparentForImageViewInFragment(Activity activity, View needOffsetView, DrawerLayout drawerLayout) {
        setTranslucentForImageViewInFragment(activity, 0, needOffsetView,drawerLayout);
    }
    ...
    public static void setTranslucentForImageViewInFragment(Activity activity, @IntRange(from = 0, to = 255) int statusBarAlpha,
                                                            View needOffsetView, DrawerLayout drawerLayout ) {
