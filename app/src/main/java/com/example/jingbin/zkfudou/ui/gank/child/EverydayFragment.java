...
import com.example.jingbin.zkfudou.adapter.EverydayAdapter;
import com.example.jingbin.zkfudou.base.BaseFragment;
import com.example.jingbin.zkfudou.bean.AndroidBean;
import com.example.jingbin.zkfudou.databinding.FragmentEverydayBinding;
import com.example.jingbin.zkfudou.databinding.HeaderItemEverydayBinding;
import com.example.jingbin.zkfudou.http.rx.RxBus;
import com.example.jingbin.zkfudou.http.rx.RxBusBaseMessage;
...
import com.example.jingbin.zkfudou.viewmodel.gank.EverydayViewModel;
...
import static com.example.jingbin.zkfudou.viewmodel.gank.EverydayViewModel.getTodayTime;
                                ...
                                public BannerViewHolder createViewHolder() {
                                    return new BannerViewHolder<String>() {
                                        ...
                                        public void onBind(Context context, int position, String data) {
                                            ...
                                            GlideUtil.displayEspImage(data, imageView, 3,1);
                                        }
                                    };
                                }
                            }).start();
